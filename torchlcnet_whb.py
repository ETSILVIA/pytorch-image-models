...
class TorchLCNet(nn.Module):
    def __init__(self, scale=1.0, class_num=1000, dropout_prob=0.2, class_expand=512):
        super().__init__()
        self.scale = scale
        ...
        self.triple_eye=nn.Linear(self.class_expand,256)
        self.triple_glass=nn.Linear(self.class_expand,256)
